            ...
            return (
              <SwiperSlide key={item?.id}>
                <Image
                  ...
                  width={240}
                  height={240}
                  className="w-[160px] h-[150px] lg:h-[240px] rounded-xl mx-auto border bg-black/20 hover:shadow-xl duration-300"
                />
              </SwiperSlide>
            );
          })}
